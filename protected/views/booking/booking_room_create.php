...
<aside class="right-side">
    <section class="content-header">
        <h1>
            <img src="images/32/booking_add.png" alt=""/>
            เพิ่มรายการจองห้องประชุม
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo Yii::app()->createUrl("Site/Index"); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?php echo Yii::app()->createUrl("booking/booking_create"); ?>"> ห้องประชุม</a></li>
            <li class="active">เพิ่มรายการจองห้องประชุม</li>
        </ol>
    </section>
