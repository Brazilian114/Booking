        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
                ...
                <div class="input-group">
                    ...
                    <?php echo $frm->textField($model, "member_address", array('class' => 'form-control', 'placeholder' => 'ระบุที่อยู่..')); ?>
                </div>
            </div>
        </div>
                ...
                <div class="input-group">
                    ...
                    echo $frm->dropdownList($model, "group_dep", GroupDepModels::getGroupDep(), array(
                        ...
                        'ajax' => array(
                            ...
                            'data' => array('groupdep_id' => 'js:this.value', 'YII_CSRF_TOKEN' => Yii::app()->request->csrfToken)
                    )));
                    ?>
                </div>
            </div>
